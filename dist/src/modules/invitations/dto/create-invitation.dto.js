...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'new.hire@acme.com' }),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], CreateInvitationDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: enums_1.Role, example: enums_1.Role.EMPLOYEE }),
    (0, class_validator_1.IsEnum)(enums_1.Role),
    __metadata("design:type", String)
], CreateInvitationDto.prototype, "role", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Optional department to associate.' }),
