...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Master switch for push notifications.' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Per-type toggles, keyed by notification type, e.g. { "leave.status_changed": false }.',
        example: { 'leave.status_changed': true, 'payslip.ready': false },
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsObject)(),
    __metadata("design:type", Object)
], UpdatePreferencesDto.prototype, "types", void 0);
